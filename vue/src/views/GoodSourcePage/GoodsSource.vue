<template>
  <div class="goods-box">
    ...
    <div class="goods" v-for="(item, index) in cgoods"
      ...
      <img class="goods-img" v-if="item.picture!=''" :src="'http://127.0.0.1:9000' + '/file/' + item.picture" alt="" />
      <img class="goods-img" v-if="item.picture==''" :src="'http://127.0.0.1:9000' + '/file/' + 'wutu.gif'" alt="" />
...
<!--      <img class="goods-img" v-if="item.picture !== ''" :src="`${'http://127.0.0.1:9000'}/file/${item.picture}`" alt="" />-->
<!--      <img class="goods-img" v-else :src="`${'http://127.0.0.1:9000'}/file/wutu.gif`" alt="" />-->
