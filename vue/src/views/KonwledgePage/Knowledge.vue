...
<div class="knowledge-box">
  <div class="knowledge" v-for="(item, index) in cknowledges" :key="index">
    <div class="flipper" >
      <div class="front">
        <video class="knowledge-img" width="200px" height="160px" v-if="item.type==='mp4'||item.type==='MP4'" accept="MP4,mp4" :src="'http://127.0.0.1:9000' + '/file/' + item.picPath" controls autoplay/>
        <img v-else class="knowledge-img" :src="'http://127.0.0.1:9000' + '/file/' + item.picPath" alt="" />
